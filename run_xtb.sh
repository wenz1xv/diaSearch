...
echo "Work as xtb isomers search mode."
...
cp config/submit_xtb.pbs ./
cp config/nmr_xtb.sh ./
chmod +x nmr_xtb.sh config/molclus/molclus config/molclus/isostat config/molclus/xyz2QC
:>info.log
qsub -o info.log -e info.log -N $name submit_xtb.pbs